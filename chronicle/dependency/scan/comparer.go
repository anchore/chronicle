...
// comparison. Lives here because it touches grype; dependency.ComputeDiff drives
// it when comparing the two scans.
type grypeVersionComparer struct{}

// NewVersionComparer returns the grype-backed VersionComparer that
// dependency.ComputeDiff drives when comparing the two scans.

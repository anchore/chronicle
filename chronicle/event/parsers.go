...
func ParseGroupTaskType(e partybus.Event) (*Group, error) {
	if err := checkEventType(e.Type, GroupTaskType); err != nil {
		return nil, err
	}
...
func ParseTreeTaskType(e partybus.Event) (*Tree, error) {
	if err := checkEventType(e.Type, TreeTaskType); err != nil {
		return nil, err
	}
